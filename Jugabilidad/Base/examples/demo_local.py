...
def run():
    ...
    # Create enemies with different flight patterns
    enemy1 = Enemy(WIDTH//2, 120, flight_pattern="linear_down")
    enemy2 = Enemy(WIDTH//2 - 160, 180, flight_pattern="sinusoidal")
    enemy3 = Enemy(WIDTH//2 + 160, 180, flight_pattern="zigzag")
    ...
    while running:
        ...
        bullets.update()
        enemies.update()  # Update enemy flight patterns
        ...
        pattern_txt = font.render("Patrones: linear_down, sinusoidal, zigzag", True, (230, 230, 240))
        screen.blit(pattern_txt, (12, 40))
        pygame.display.flip()
        clock.tick(60)
